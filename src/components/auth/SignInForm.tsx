...
import { IconChevronLeft, IconEye, IconEyeOff, IconStar } from "@tabler/icons-react";
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (!isChecked) {
      setAlert({
        variant: 'error',
        title: 'Error',
        message: 'Please check "Keep me logged in" to continue.'
      });
      return;
    }
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    >
                      {showPassword ? (
                        <IconEye className="text-gray-500 dark:text-gray-400 size-5" />
                      ) : (
                        <IconEyeOff className="text-gray-500 dark:text-gray-400 size-5" />
                      )}
                    </span>
                  </div>
                </div>
